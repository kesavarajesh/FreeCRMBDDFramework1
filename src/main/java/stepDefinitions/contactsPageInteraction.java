...
//		driver.findElement(By.name("name='first_name'")).sendKeys(fname);
//		driver.findElement(By.name("name='surname'")).sendKeys(lname);
//		driver.findElement(By.name("name='company_position'")).sendKeys(position);
